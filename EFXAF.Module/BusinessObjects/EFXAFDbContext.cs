...
[TypesInfoInitializer(typeof(DbContextTypesInfoInitializer<EFXAFEFCoreDbContext>))]
public class EFXAFEFCoreDbContext : DbContext
{
    public EFXAFEFCoreDbContext(DbContextOptions<EFXAFEFCoreDbContext> options) : base(options)
    {
    }
